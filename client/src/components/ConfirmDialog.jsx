        ...
        >
          ...
          >
            ...
            <div className="mt-5 flex justify-end gap-2">
              <button onClick={onCancel} className="rounded-lg px-4 py-2.5 text-body font-medium hover:bg-canvas dark:hover:bg-canvas-dark transition-colors min-h-[44px]">
                Cancel
              </button>
              <button
                onClick={onConfirm}
                className="rounded-lg bg-rose px-4 py-2.5 text-body font-medium text-white hover:opacity-90 transition-opacity min-h-[44px]"
              >
                {confirmLabel}
              </button>
            </div>
